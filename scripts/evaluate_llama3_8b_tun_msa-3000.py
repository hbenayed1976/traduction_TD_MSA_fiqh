"""
Évaluation autonome — LLaMA 3-8B fine-tuné (adapteur LoRA)
...
Différences clés :
  ...
  - trust_remote_code supprimé (non nécessaire pour LLaMA 3)
  - Format prompt : balises LLaMA 3 chat (<|begin_of_text|>, etc.)
  - Fix dtype bfloat16 conservé (applicable aussi à LLaMA 3)
...
LORA_DIR     = r"C:\Users\infocom\tradiction_dialect\llama3_8b_tun_msa_output-3000"
...
print(SEP)
print("  Évaluation LLaMA 3-8B LoRA — Traduction Tunisien → MSA")
print(SEP)
...
def export_excel(results, summary, out_path):
    ...
    title_cell.value = "LLaMA 3-8B LoRA — Évaluation Traduction Tunisien → MSA"
...
# ── Appel export ──────────────────────────────────────────────
excel_path = os.path.join(OUTPUT_DIR, "llama3_evaluation_expert.xlsx")
...
print("\n" + SEP)
print("  ✅ ÉVALUATION LLaMA 3-8B TERMINÉE AVEC SUCCÈS!")
print(SEP)
