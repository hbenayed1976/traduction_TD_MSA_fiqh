"""
plot_learning_curves_mistral7b.py
--------------------------------
Visualisation des courbes d'apprentissage du modèle Mistral-7B.
Compatible avec finetune_mistral7b_tun_msa_v3000.py.
...
SAVE_PATH  = os.path.join(OUTPUT_DIR, "courbe_apprentissage_mistral7b.png")
SEP        = "=" * 60
...
def plot_learning_curves(
    ...
    title: str = "Courbe d'apprentissage — Mistral-7B (Tunisien → MSA)",
) -> str:
...
if __name__ == "__main__":
    print(SEP)
    print("  Mistral-7B — Courbes d'apprentissage")
    print(SEP)
    ...
    if state_path is None:
        ...
        print("   Lancez d'abord finetune_mistral7b_tun_msa_v3000.py.")
    else:
